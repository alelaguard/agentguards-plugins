...
|---|---|---|---|---|
| [`agentguards-claude`](./claude) | Claude Code | hosted | `0.2.31` | MCP server + enforcing hooks (input, Bash, web-content) and security instructions. |
| [`agentguards-codex`](./codex) | OpenAI Codex | hosted | `0.2.14` | Enforcing hooks (input, shell, web-content) + MCP server and security instructions. |
